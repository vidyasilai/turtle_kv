...
//=#=#==#==#===============+=+=+=+=++=++++++++++++++-++-+--+-+----+---------------
//
class BlockedLeafPageView : public llfs::PageView
{
 public:
  ...
  explicit BlockedLeafPageView(std::shared_ptr<const llfs::PageBuffer>&& page_buffer) noexcept;

  llfs::PageLayoutId get_page_layout_id() const override
  {
    return BlockedLeafPageView::page_layout_id();
  }
